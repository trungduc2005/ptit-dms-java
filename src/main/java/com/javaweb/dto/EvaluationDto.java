...
/**
 * DTO cho payload export phiếu chấm.
 * Dùng EvaluationDto.Root làm kiểu @RequestBody.
 */
public class EvaluationDto {
    ...
    /* -------- EVALUATION FORM (siêu dữ liệu của phiếu) -------- */
    @JsonIgnoreProperties(ignoreUnknown = true)
    ...
    public static class Indicator {
        ...
        private List<Pi> pis;
        private Double weight; // trọng số của CLO
    ...
    public static class Pi {
        ...
        private Double cloPisWeight; // trọng số PI trong CLO
    ...
    public static class StudentEvaluation {
        ...
        /** Tiện ích: map PI -> điểm (dễ dùng khi render Excel) */
    ...
    public static class Score {
        private String piId;   // ví dụ: "C3.2."
        private Double score;  // ví dụ: 9.5
